...
- This repo is the frontend PWA. Backend data and pipeline work belongs in the sibling `manhwa_db` repo unless the user explicitly asks for cross-repo work.
